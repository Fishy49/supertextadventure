...
# Tables for Solid Queue (database-backed Active Job adapter), installed into
# the primary database rather than a separate queue database.
# Mirrors db/queue_schema.rb from solid_queue 1.6.0.
